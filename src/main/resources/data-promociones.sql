-- Promociones: init seguro (IF NOT EXISTS + INSERT IGNORE)
...
INSERT IGNORE INTO promociones (titulo, descripcion, descuento_porcentaje, monto_minimo, fecha_inicio, fecha_fin, activa)
